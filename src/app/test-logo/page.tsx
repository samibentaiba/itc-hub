  ...
  return (
    <div className="min-h-screen p-8 space-y-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-8">Logo Component Test Page</h1>
        
        {/* Basic Logo Variants */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Basic Logo Variants</h2>
        ...
        {/* Logo Types */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Logo Types</h2>
        ...
        {/* Logo Sizes */}
        <section className="space-y-4">
          <h2 className="text-2xl font-semibold">Logo Sizes</h2>
