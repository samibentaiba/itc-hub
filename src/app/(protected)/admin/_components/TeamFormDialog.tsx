...
// /app/(protected)/admin/_components/TeamFormDialog.tsx
"use client";
...
export function TeamFormDialog({ isOpen, onClose, onSubmit, isLoading, initialData, departments }: TeamFormDialogProps) {
  ...
  useEffect(() => {
    if (isOpen) {
      form.reset(isEditMode && initialData ? { name: initialData.name, description: initialData.description ?? undefined, departmentId: initialData.departmentId } : { name: "", description: "", departmentId: "" });
    }
