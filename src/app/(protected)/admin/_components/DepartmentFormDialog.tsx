...
// /app/(protected)/admin/_components/DepartmentFormDialog.tsx
"use client";
...
export function DepartmentFormDialog({ isOpen, onClose, onSubmit, isLoading, initialData }: DepartmentFormDialogProps) {
  ...
  useEffect(() => {
    if (isOpen) {
      form.reset(isEditMode && initialData ? { name: initialData.name, description: initialData.description ?? undefined } : { name: "", description: "" });
    }
