// /admin/_components/UserFormDialog.tsx
...
/**
 * A unified dialog for both adding a new user and editing an existing one.
 * Uses react-hook-form for state management and zod for validation.
 */
export default function UserFormDialog({ isOpen, onClose, onSubmit, isLoading, initialData }: UserFormDialogProps) {
