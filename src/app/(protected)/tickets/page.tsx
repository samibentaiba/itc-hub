...
// It's a good practice to type the data you expect from your API
type ApiTicket = {
  id: string;
  title: string;
  ...
  assignee?: { name: string; avatar: string | null; id: string } | null;
  reporter?: { name: string; avatar: string | null; id: string } | null;
  createdAt: string;
  updatedAt: string;
};
...
export default async function TicketsPage() {
  ...
  const tickets = ticketsData.tickets.map((ticket: ApiTicket) => ({
    id: ticket.id || "",
    title: ticket.title || "",
    ...
    status: (ticket.status === "OPEN"
      ...
      ? "in-progress"
      : "resolved") as "new" | "in-progress" | "resolved",
  ...
  return <TicketsClientPage initialTickets={tickets} initialStats={stats} />;
}
