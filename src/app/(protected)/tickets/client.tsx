...
export default function TicketsClientPage({
  ...
  const {
    ...
    statusFilter,
    priorityFilter,
    typeFilter, // ADDED: Destructure new filter state
    stats,
    filteredTickets,
    setSearchTerm,
    setStatusFilter,
    setPriorityFilter,
    setTypeFilter, // ADDED: Destructure new filter setter
    getStatusColor,
    getPriorityColor,
    formatStatus,
      ...
      <Table>
        <TableHeader>
          <TableRow>
            ...
            <TableHead>From</TableHead> {/* ADDED: Workspace column */}
