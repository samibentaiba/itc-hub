...
const vlogs: { [key: string]: Vlog } = {
  "vlog-1": {
    ...
    content: [
        ...
        { type: 'paragraph', text: 'This is the full content of the first vlog post. It can be a long text with markdown formatting. Thanks to @samibentaiba for the help!' },
        { type: 'heading', level: 3, text: 'Section 1.1' },
        { type: 'paragraph', text: 'Here is some content for the first section.' },
        { type: 'image', src: 'https://placehold.co/800x450.png?text=In-content+Image', alt: 'In-content image' },
        { type: 'heading', level: 3, text: 'Section 1.2' },
        { type: 'paragraph', text: 'Here is some more content. @anotheruser was also involved.' },
        { type: 'code', language: 'typescript', code: 'console.log("Hello, world!");' },
    ],
  },
  "vlog-2": {
    slug: "vlog-2",
    ...
    gallery: [],
    content: [
        { type: 'paragraph', text: 'This is the full content of the second vlog post.' },
    ],
  },
  "vlog-3": {
    slug: "vlog-3",
    ...
    gallery: [],
    content: [
        { type: 'paragraph', text: 'This is the full content of the third vlog post.' },
    ],
  },
};
...
export default async function VlogPage({ params }: { params: { slug: string } }) {
  const vlog = vlogs[params.slug];
        ...
        <div className="mb-8 flex items-center gap-4">
            <div className="flex items-center gap-2">
                <Avatar className="h-10 w-10">
                    <AvatarImage src={'https://github.com/Sami.png'} alt={vlog.author} />
