// src/app/(home)/vlogs/[slug]/client.tsx
"use client";
...
import type { VlogDetail, ContentBlock } from "../types";

interface VlogDetailClientPageProps {
  vlog: VlogDetail;
...
export default function VlogDetailClientPage({ 
  vlog, 
  usersById 
}: VlogDetailClientPageProps) {
  return (
