-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'SUPERLEADER', 'LEADER', 'MEMBER', 'GUEST');

-- CreateEnum
CREATE TYPE "TicketType" AS ENUM ('TASK', 'MEETING', 'EVENT');

-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('OPEN', 'IN_PROGRESS', 'SCHEDULED', 'VERIFIED', 'CLOSED', 'CANCELLED');
